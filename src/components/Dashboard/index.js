import { Col, DatePicker, Divider, Row, Statistic, Table, Typography } from "antd";
...
export default function Dashboard() {
    const { monthlyProfit, topClientList, totalInvoiced, totalReceived, totalClients, inProgress } = useSelector(
        ...
        <div>
            <div className="bg-white px-6 pb-4 mb-6">
                ...
                <Row gutter={[8, 0]}>
                    <Col span={24} md={8}>
                        <Statistic
                            title={<Text className="font-semibold text-xl">Total Invoiced</Text>}
                            value={totalInvoiced}
                            loading={inProgress}
                            formatter={value => (
                    ...
                    <Col span={24} md={8}>
                        <Statistic
                            title={<Text className="font-semibold text-xl">Total Received</Text>}
                            value={totalReceived}
                            loading={inProgress}
                            formatter={value => (
                    ...
                    <Col span={24} md={8}>
                        <Statistic
                            title={<Text className="font-semibold text-xl">Total Clients</Text>}
                            value={totalClients}
                            loading={inProgress}
                            formatter={value => (
            ...
            <Row>
                <Col className="bg-white px-6 pb-4" span={24} xxl={16}>
                    <Row justify="space-between" align="middle">
                        ...
                        <DatePicker className="h-max" onChange={handleChangeYear} picker="year" />
                    </Row>
                    <Divider className="mt-0 mb-4" />
                    <Row>
