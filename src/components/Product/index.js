...
export default function ProductPage() {
  const { productList, total, page, pager, error, reload } = useSelector(
  ...
  const showDeleteUserModal = slug =>
    setDeleteProductModal({ visible: true, slug });
  const closeDeleteUserModal = () =>
    setDeleteProductModal({ visible: false, slug: "" });
  ...
  return (
    <Space
      className="product-page max-w-full"
      direction="vertical"
      size="large"
    >
      <div className="flex flex-col-reverse justify-between xl:flex-row">
        ...
        <Space
          className="flex-row mb-6 xl:mb-0 xl:items-end xl:flex-col"
          size="middle"
        >
